  ...
  //  var bannerView: GADBannerView!
    ...
    override func viewDidLoad() {
        ...
        addBannerViewToView(adBaseView, view: adBaseView)
            ...
            adBaseView.adUnitID = "ca-app-pub-8096571252242204/7685411144"
...
func addBannerViewToView(_ bannerView: GADBannerView,view:UIView) {
    ...
    func setAd(){
        ...
        GADInterstitialAd.load(withAdUnitID:"ca-app-pub-8096571252242204/5080532757",request: request,completionHandler: { [self] ad, error in
            if let error = error {
